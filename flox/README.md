...
For example, use `flox init -d plugins/version-control-systems/git` if you would want to create a new environment for Git-related tools.
...
For example, use `flox edit -d plugins/version-control-systems/git` if you would want to make changes the environment of Git-related tools.
